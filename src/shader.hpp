...
public:
  ...
  void set_uniform_float(std::string name, float) const;

  void set_uniform_float(std::string name, float, float) const;

  void set_uniform_float(std::string name, float, float, float) const;

  void set_uniform_float(std::string name, float, float, float, float) const;
